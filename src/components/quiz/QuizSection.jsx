...
export default function QuizSection() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-2">
            {selectedChapters !== null && (
              <span className="text-xs px-2 py-0.5 rounded-full" style={{ background: 'rgba(79,209,197,0.15)', color: '#4fd1c5', border: '1px solid rgba(79,209,197,0.3)', fontFamily: 'JetBrains Mono' }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
          ...
          <button
            ...
            style={{
              border: selectedChapters === null ? '1px solid rgba(79,209,197,0.5)' : '1px solid rgba(255,255,255,0.08)',
              background: selectedChapters === null ? 'rgba(79,209,197,0.12)' : 'rgba(255,255,255,0.02)',
            }}
          >
            <div className="text-lg mb-1">📚</div>
            <div className="text-xs font-semibold" style={{ color: selectedChapters === null ? '#4fd1c5' : '#78716c', fontFamily: 'JetBrains Mono, monospace' }}>Tous chapitres</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          {MODES.map(mode => (
            <button
              ...
              style={{
                border: selectedMode === mode.id ? '1px solid rgba(79,209,197,0.45)' : '1px solid rgba(255,255,255,0.08)',
                background: selectedMode === mode.id ? 'rgba(79,209,197,0.1)' : 'rgba(255,255,255,0.02)',
              }}
            >
              <div className="text-lg shrink-0">{mode.label.split(' ')[0]}</div>
              <div>
                <div className="text-xs font-semibold" style={{ color: selectedMode === mode.id ? '#4fd1c5' : '#e2e8f0' }}>
      ...
      {/* Step 3: Launch */}
      <div className="glass rounded-2xl p-5" style={{ border: '1px solid rgba(79,209,197,0.18)' }}>
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <button
            ...
            style={{
              background: pool.length > 0 ? 'linear-gradient(135deg, #4fd1c5, #ee7f9d)' : 'rgba(255,255,255,0.06)',
