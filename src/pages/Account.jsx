...
export default function Account() {
  ...
  return (
    <div className="min-h-screen" style={{ paddingBottom: 'calc(80px + env(safe-area-inset-bottom))' }}>
      <MobileHeader title="Mon compte" subtitle="Gestion du compte PHYSCHIM·X" />

      <div className="px-4 py-6 max-w-lg mx-auto">
        {/* Desktop back button */}
        <button onClick={() => navigate(-1)} className="hidden md:flex text-xs mb-6 items-center gap-2 select-none"
